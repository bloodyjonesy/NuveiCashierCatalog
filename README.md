...
2. Set env vars: `NUVEI_MERCHANT_ID`, `NUVEI_MERCHANT_SITE_ID`, `NUVEI_SECRET_KEY`, and `NEXT_PUBLIC_APP_URL` (your Railway URL).
3. Deploy; use the default `*.railway.app` domain.
